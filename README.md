...
![Quick Side Note 设置界面](docs/images/quick_note_settings_preview_v1_2.png)
...
- 设置界面支持 API Key、开机启动、侧键选择、浏览器键拦截和双击间隔。
...
- `QuickSideNote_Setup_v1.2.0.exe`：推荐安装器。
- `QuickSideNote_App_v1.2.0.zip`：便携版压缩包。
...
```text
release\QuickSideNote_App_v1.2.0
release\QuickSideNote_Setup_v1.2.0.exe
```
