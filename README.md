...
![Quick Side Note 设置界面](docs/images/quick_note_settings_preview_v1_5.png)
...
- v1.5.0 暖色纸张质感 UI，顶部横排页签和底部快捷操作栏。
...
- `QuickSideNote_Setup_v1.5.0.exe`：推荐安装器。
- `QuickSideNote_App_v1.5.0.zip`：便携版压缩包。
...
```text
release\QuickSideNote_App_v1.5.0
