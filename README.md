...
![Quick Side Note 设置界面](docs/images/quick_note_settings_preview_v1_3.png)
...
- v1.3 设置界面采用左侧导航，支持 API Key、开机启动、侧键选择、浏览器键拦截和双击间隔。
...
- `QuickSideNote_Setup_v1.3.0.exe`：推荐安装器。
- `QuickSideNote_App_v1.3.0.zip`：便携版压缩包。
...
```text
release\QuickSideNote_App_v1.3.0
release\QuickSideNote_Setup_v1.3.0.exe
```
