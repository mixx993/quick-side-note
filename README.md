...
- v1.3.1 设置界面采用左侧导航和滚动内容区，支持 API Key、开机启动、侧键选择、浏览器键拦截和双击间隔。
...
- `QuickSideNote_Setup_v1.3.1.exe`：推荐安装器。
- `QuickSideNote_App_v1.3.1.zip`：便携版压缩包。
...
```text
release\QuickSideNote_App_v1.3.1
